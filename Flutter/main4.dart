...
class _MyHomePageState extends State<MyHomePage> {
  ...
  onSwitchValueChanged(bool newVal){
    setState(() {
      isSwitched = newVal;
      if(isSwitched == false) {device.publishMessage(aws.topic, '{"variable":"Pump A","value":"OFF"}');}
      else{device.publishMessage(aws.topic, '{"variable":"Pump A","value":"ON"}');}
    });
//    isSwitched = newVal;
  }
...
//      flowRate = 0.0;
//      tankLevel = 0.0;
//      device.publishMessage(aws.topic, '{"variable":"Pump A","value":"OFF"}');
      return 0xFFF44336;
    }
    else {
//      temperature = 42.4;
//      flowRate = 10.5;
//      tankLevel = 10.0;
//      device.publishMessage(aws.topic, '{"variable":"Pump A","value":"ON"}');
      return 0xFF8BC34A;
    }
  }
...
//    var aux1 = "{\"data\":[{\"temperature\":25.6}, {\"flowRate\":11.9}, {\"tankLevel\":85.3}]}";
          Data data = Data.fromJson(jsonDecode(aux1));
//        print(aux1);
//        print(data.variables[0].temperature);
//        print(data.variables[1].flowRate);
//        print(data.variables[2].tankLevel);
//        print(data.valueFlowRate);
//        print(data.valueTankLevel);

          try {
            temperature = data.variables[0].temperature;
...
class Variables{
  final double temperature, flowRate, tankLevel;

  Variables({this.temperature, this.flowRate, this.tankLevel});
...
//  Data(this.variable, this.value);
//  factory Data.fromJson(dynamic json){
//    return Data(json['variable'] as String, json['value'] as double);
//  }
//  @override
//  String toString(){

...
void connect_to_aws(AWS_Connection aws, AWSIoTDevice device) async{
  try {
...
//                                device.publishMessage(aws.topic, '{"Pump A": "ON"}');
                    ...
                    Row(
                      children: <Widget>[
                        Container(
                          margin: EdgeInsets.only(top: 20.0, left: 20.0, bottom: 40.0),
...
//                        ),
                      RaisedButton(
                        onPressed: () {
                          !_isButtonDisabled ? connect_to_aws(aws, device) : null;
                          },

                        child: new Text(
                            !_isButtonDisabled ? 'Reconnect' : 'Connected',
